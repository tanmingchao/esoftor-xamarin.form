...
using eSoftorApp.Controls;
using eSoftorApp.Droid.Extensions;
using eSoftorApp.Droid.Renderers;
using Xamarin.Forms;
...
namespace eSoftorApp.Droid.Renderers
{
    public class CustomTabbedPageRenderer : TabbedPageRenderer
    {
        ...
        void ChangeMShiftingModeFalse()
        {
            if (ViewGroup != null && ViewGroup.ChildCount > 0)
            {
                BottomNavigationMenuView bottomNavigationMenuView = ViewGroup.FindChildOfType<BottomNavigationMenuView>();
