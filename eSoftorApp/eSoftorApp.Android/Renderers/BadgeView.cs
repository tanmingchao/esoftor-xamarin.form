...
namespace eSoftorApp.Droid.Renderers
{
    public class BadgeView : TextView
    {
        ...
        private static Android.Views.Animations.Animation _fadeInAnimation;
        private static Android.Views.Animations.Animation _fadeOutAnimation;

        private Context _context;
        private readonly Android.Graphics.Color _defaultBadgeColor = Android.Graphics.Color.ParseColor("#CCFF0000");
        ...
        public Android.Graphics.Color BadgeColor
        {
        ...
        {
            get { return new Android.Graphics.Color(CurrentTextColor); }
